...
def plot_split_mnist_figure4(results_dict, 
                             tasks_labels=None,
                             out_file=None):
    ...
    color_list = ["red", "orange", "green", "blue", "purple", "brown","pink", "gray", "orchid", "magenta", "olive", "darkcyan"]
    line_styles = ["-", "--", "-.", ":"]
    all_methods = sorted(list(results_dict.keys()))
    ...
    for col in range(6):
        for row in range(2):
            ...
            ax.set_title(tasks_labels[col], fontsize=10)
    ...
    fig.legend(handles, labels,loc='center left',bbox_to_anchor=(0.85, 0.5),fontsize=9)
